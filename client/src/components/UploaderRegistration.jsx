...
import {
    Avatar, Button, CssBaseline, TextField, Paper, Box, Grid, Typography, createTheme, ThemeProvider, Alert, List, ListItem, ListItemText, InputAdornment
} from '@mui/material';
...
export default function UploaderRegistrationForm() {
    ...
    const onSubmit = async (data) => {
        try {
            const response = await fetch('/api/uploader/register', {
                method: 'POST',
                headers: {
